...
\section{Exploit potential of unmanaged memory}
...
\begin{figure}[h]
  ...
  \caption{Result of an analysis of memory usage in real world WebAssembly binaries, taken from \citet{hilbig_empirical_2021}.}  
...
\begin{figure}[h]
  ...
  \caption{Result of an analysis of allocators used in real world WebAssembly binaries, taken from \citet{hilbig_empirical_2021}.}  
\label{fig:analysis_used_alloc}
\end{figure}

\begin{table*}
\caption{Result of an analysis of potentially harmful functions imported into WebAssembly modules. Taken from \citet{hilbig_empirical_2021} with some modifications.}
